...
DATA_DIR=${1:-${DATA_DIR:-"/data/KconfSpeech/test-wav/KconfSpeech"}}
MODEL_CONFIG=${2:-${MODEL_CONFIG:-"/configs/jasper10x5dr_sp_offline_specaugment.yaml"}}
RESULT_DIR=${3:-${RESULT_DIR:-"results"}}
CHECKPOINT=${4:-${CHECKPOINT:-"results/Jasper_epoch10_checkpoint.pt"}}
...
CMD+=" --wav $PWD$DATA_DIR/D26/G02/S000011/000300.wav"
